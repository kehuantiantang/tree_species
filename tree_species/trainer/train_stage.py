...
from tree_species.dataset import TreeSpeciesStageDataset
...
class Trainer(object):
    ...
    def prepare_dataset(self):
        ...
        train_dataset = TreeSpeciesStageDataset(hyper_dataset.img_path, hyper_dataset.train_txt,
                                            hyper_dataset.class_names, transforms = train_aug)
        Logger.debug('Train dataset:', len(train_dataset))



        val_dataset = TreeSpeciesStageDataset(hyper_dataset.img_path, hyper_dataset.val_txt, hyper_dataset.class_names, transforms = test_aug)
        Logger.debug('Val dataset:', len(val_dataset))


        test_dataset = TreeSpeciesStageDataset(hyper_dataset.img_path, hyper_dataset.test_txt, hyper_dataset.class_names, transforms = test_aug)
